...
type PaymentMethodReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MethodType    string                 `protobuf:"bytes,1,opt,name=methodType,proto3" json:"methodType,omitempty"`
	Data          []byte                 `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PaymentMethodReq) Reset() {
	*x = PaymentMethodReq{}
...
func (x *PaymentMethodReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaymentMethodReq) ProtoMessage() {}

func (x *PaymentMethodReq) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_user_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaymentMethodReq.ProtoReflect.Descriptor instead.
func (*PaymentMethodReq) Descriptor() ([]byte, []int) {
	return file_proto_user_user_proto_rawDescGZIP(), []int{2}
}

func (x *PaymentMethodReq) GetMethodType() string {
	if x != nil {
		return x.MethodType
	}
	return ""
...
func (x *PaymentMethodReq) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
type PaymentMethodRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	MethodType    string                 `protobuf:"bytes,2,opt,name=methodType,proto3" json:"methodType,omitempty"`
	Data          []byte                 `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PaymentMethodRes) Reset() {
	*x = PaymentMethodRes{}
...
func (x *PaymentMethodRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaymentMethodRes) ProtoMessage() {}

func (x *PaymentMethodRes) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_user_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaymentMethodRes.ProtoReflect.Descriptor instead.
func (*PaymentMethodRes) Descriptor() ([]byte, []int) {
	return file_proto_user_user_proto_rawDescGZIP(), []int{3}
}

func (x *PaymentMethodRes) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PaymentMethodRes) GetMethodType() string {
	if x != nil {
		return x.MethodType
	}
	return ""
...
func (x *PaymentMethodRes) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\tupdatedAt\x18\v \x01(\tR\tupdatedAt\"F\n" +
	"\x10PaymentMethodReq\x12\x1e\n" +
	"\n" +
	"methodType\x18\x01 \x01(\tR\n" +
	"methodType\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"V\n" +
	"\x10PaymentMethodRes\x12\x0e\n" +
